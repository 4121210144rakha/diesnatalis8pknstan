  ...
  return (
    <main className="text-center">
      ...
      <div id="Explore" className="py-8">
        ...
        {/* Slider */}
        <div className="flex flex-col sm:flex-row my-10 sm:justify-around justify-center items-center">
          <div className="my-8 hover:scale-105 transition-all duration-300 ease-in-out md:mx-2 w-72 justify-center text-center bg-cover bg-center"  style={{backgroundImage:`url("https://images.unsplash.com/photo-1565035010268-a3816f98589a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=688&q=80")`, height:"28rem"}}>
            <div className="group bottom-0 pb-10 hover:backdrop-blur-sm items-center flex hover:justify-center justify-end flex-col h-full transition duration-300 ease-in-out">
              <h3 className="text-lg group-hover:hidden"><b>Opening Ceremony</b></h3>
              <p className="group-hover:hidden">Gedung G</p>
              <Image className="hidden group-hover:block" src={Lock} width={30} height={30} alt='Lock'/>
            </div>
          </div>
          
          <div className="my-8 hover:scale-105 transition-all duration-300 ease-in-out md:mx-2 w-72 justify-center text-center bg-cover bg-center"  style={{backgroundImage:`url("https://images.unsplash.com/photo-1491975474562-1f4e30bc9468?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=687&q=80")`, height:"28rem"}}>
            <div className="group bottom-0 pb-10 hover:backdrop-blur-sm items-center flex hover:justify-center justify-end flex-col h-full transition duration-300 ease-in-out">
          ...
          <div className="my-8 hover:scale-105 transition-all duration-300 ease-in-out md:mx-2 w-72 justify-center text-center bg-cover bg-center"  style={{backgroundImage:`url("https://plus.unsplash.com/premium_photo-1661856221850-8d6cc299049c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=687&q=80")`, height:"28rem"}}>
            <div className="group bottom-0 pb-10 hover:backdrop-blur-sm items-center flex hover:justify-center justify-end flex-col h-full transition duration-300 ease-in-out">
          ...
          <div className="my-8 hover:scale-105 transition-all duration-300 ease-in-out md:mx-2 w-72 justify-center text-center bg-cover bg-center"  style={{backgroundImage:`url("https://images.unsplash.com/photo-1603910234616-3b5f4a6be2b4?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=687&q=80")`, height:"28rem"}}>
            <div className="group bottom-0 pb-10 hover:backdrop-blur-sm items-center flex hover:justify-center justify-end flex-col h-full transition duration-300 ease-in-out">
          ...
          <div className="my-8 hover:scale-105 transition-all duration-300 ease-in-out md:mx-2 w-72 justify-center text-center bg-cover bg-center"  style={{backgroundImage:`url("https://images.unsplash.com/photo-1576328077645-2dd68934d2b7?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=627&q=80")`, height:"28rem"}}>
            <div className="group bottom-0 pb-10 hover:backdrop-blur-sm items-center flex hover:justify-center justify-end flex-col h-full transition duration-300 ease-in-out">
      ...
      <div>
        ...
        <div>
          <Lombacard heading="Futsal" description="Lorem ipsum dolor sit amet" url="https://google,com"/>
        </div>
      </div>
