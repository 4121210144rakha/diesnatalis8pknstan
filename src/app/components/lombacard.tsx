...
export default function lombacard(props:any) {
    return(
        <div className="group my-4 items-center justify-center flex-col overflow-hidden rounded-lg hover:scale-105 transition duration-200 ease-in-out mx-4" style={{height:"28rem", width:"20rem"}}>
            ...
            <div id="down" className="-translate-y-32 group-hover:-translate-y-60 transition duration-500 ease-in-out px-2 mask-image-to-top bg-black bg-opacity-80">
