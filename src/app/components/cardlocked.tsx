...
export default function CardLocked(props:any) {
    ...
    return(
        <div ref={fadeIn} className="fade-container m-4 hover:scale-105 hover:border hover:border-gray-300 transition-all duration-300 ease-in-out md:mx-2 w-80 justify-center text-center bg-cover bg-center rounded-xl"  style={{backgroundImage:`url(`+props.url+`)`, height:"28rem"}}>
