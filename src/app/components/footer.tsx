...
export default function Footer(){
    return(
        <footer className="bg-inherit w-screen flex sm:items-center justify-center py-4 flex-col sm:">
            <div className="px-4 flex flex-col justify-center  items-center sm:flex-row-reverse">
