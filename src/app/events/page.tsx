            ...
            <>
                <section className="mt-20 text-center">
                    ...
                    <div className="flex lg:flex-row flex-col sm:justify-evenly justify-center items-center">
                        ...
                        <Lombacard  alamat="https://www.eventbrite.com/e/talkshow-yuk-jaga-bumi-kita-dengan-mulai-berinvestasi-ke-lingkungan-tickets-663452242517" wa="https://wa.me/6282245438933" heading="Talkshow: Green Economy" place="ONLINE" image="https://plus.unsplash.com/premium_photo-1679079456783-5d862f755557?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=688&q=80" text="Join Now!" panduan="https://drive.google.com/drive/u/0/folders/1Igw2nsBSgU-sCAn5iRLxbzapEblv2NCc" check="https://docs.google.com/spreadsheets/d/1StZ-xF16g-yV1TGw1gQZWv58Rw9SA-k0RpJLTMWeCxA/edit#gid=0"/>
