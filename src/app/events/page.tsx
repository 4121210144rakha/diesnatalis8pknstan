            ...
            <>
                <section className="mt-20 text-center">
                    ...
                    <div className="flex lg:flex-row flex-col sm:justify-evenly justify-center items-center">
                        ...
                        <Lombacard alamat="#" wa="https://wa.me/6285881631363" heading="Workshop ESG" caption="GEDUNG G" image="https://images.unsplash.com/photo-1544928147-79a2dbc1f389?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=687&q=80" text="Join Now!" panduan="https://drive.google.com/drive/u/0/folders/1HHNPjytnCI8tIo8dUmWOSaIYtLss7IF7" check="https://docs.google.com/spreadsheets/d/1K-81eFwNSihMWTXyxEMEha2cPiIFbFSx8Kj4L8TaEB0/edit#gid=0"/>
                    </div>
                    <div className="flex lg:flex-row flex-col sm:justify-evenly justify-center items-center">
