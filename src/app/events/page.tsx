            ...
            <>
                <section className="mt-20 text-center">
                    ...
                    <div className="flex lg:flex-row flex-col sm:justify-evenly justify-center items-center">
                        ...
                        <Lombacard alamat="https://www.eventbrite.com/e/workshop-esg-acuntability-and-sustainability-in-public-policy-tickets-661845907927" wa="https://wa.me/6285881631363" heading="Workshop ESG" caption="GEDUNG G" image="https://images.unsplash.com/photo-1544928147-79a2dbc1f389?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=687&q=80" text="Join Now!" panduan="https://drive.google.com/drive/u/0/folders/1HHNPjytnCI8tIo8dUmWOSaIYtLss7IF7" check="https://docs.google.com/spreadsheets/d/1K-81eFwNSihMWTXyxEMEha2cPiIFbFSx8Kj4L8TaEB0/edit#gid=0"/>
                    </div>
                    <div className="flex lg:flex-row flex-col sm:justify-evenly justify-center items-center">
                        ...
                        <Lombacard  alamat="https://www.eventbrite.com/e/talkshow-yuk-jaga-bumi-kita-dengan-mulai-berinvestasi-ke-lingkungan-tickets-663452242517" wa="https://wa.me/6282245438933" heading="Talkshow: Green Economy" caption="ONLINE" image="https://plus.unsplash.com/premium_photo-1679079456783-5d862f755557?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=688&q=80" text="Join Now!" panduan="https://drive.google.com/drive/u/0/folders/1Igw2nsBSgU-sCAn5iRLxbzapEblv2NCc" check="https://docs.google.com/spreadsheets/d/1StZ-xF16g-yV1TGw1gQZWv58Rw9SA-k0RpJLTMWeCxA/edit#gid=0"/>
                        <Lombacard alamat="https://www.eventbrite.com/e/kuliah-umum-pengantar-penilaian-properti-prodi-d-iii-manajemen-aset-tickets-672033970697?aff=oddtdtcreator" wa="http://wa.me/6282131002008" heading="Kuliah Umum Pengantar Penilaian Properti" caption="GEDUNG N" image="https://images.unsplash.com/photo-1558018753-62a7a4e89420?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=627&q=80" text="Join Now!" panduan="#" check="#"/>
                    </div>
                    <div className="flex lg:flex-row flex-col sm:justify-evenly justify-center items-center">
