            ...
            <>
                <section className="my-20 text-center">
                    ...
                    <div className="flex lg:flex-row flex-col sm:justify-evenly justify-center items-center mb-10">
                        ...
                        <Lombacard alamat="https://docs.google.com/forms/d/e/1FAIpQLSeunzKs_5vKcw_SOhBZSOc5YReH781neMmVe39m4qExGSJXRw/viewform" image="https://images.unsplash.com/photo-1626225015999-2e53f6aaa008?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=687&q=80" heading="Badminton" caption="Smash your way to victory!" wa="http://wa.me/6282120421260" check="/competition/Badminton" panduan="https://drive.google.com/file/d/1B-k0TH_ZU0ZZ7vMa277SrXcdWtewT0li/view" text="Play Now!"/>
                    </div>
