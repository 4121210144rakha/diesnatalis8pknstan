        ...
        isLoad?(<Loading/>):(
            <>
                <section className="my-20 text-center">
                    ...
                    <div className="flex sm:flex-row flex-col sm:justify-evenly justify-center items-center mb-10">
                        <Lombacard alamat="https://docs.google.com/forms/d/e/1FAIpQLSes435dEVii_SVz2TuoddeF5shcAmAcYUlp1x58egcSc5FDLg/viewform" image="https://images.unsplash.com/photo-1623278589094-6741f418d3bf?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=709&q=80" heading="STAN MUN" caption="Speak up. Make a difference." wa="http://wa.me/6282335195569" check="https://docs.google.com/spreadsheets/d/1skq3wRyY2fc9uUSGWjp9tw4rOU1RuJKNYq9wUePPTZA/edit?usp=sharing"/>
                        <Lombacard alamat="https://docs.google.com/forms/d/e/1FAIpQLSe9QMaB58hL844a6_l_oCgOIrQdKoKUQsHggwqzqYGsOph7Pw/viewform" image="https://images.unsplash.com/photo-1613951085587-cfe5d0a6cffc?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=634&q=80" heading="Try to Survive" caption="Test your knowledge" wa="http://wa.me/6282335195569" check="https://docs.google.com/spreadsheets/d/1UktQI3I1nC4M9LERLGFXi6kRK6tyVa-Mqd2bULx4Vdc/edit#gid=0"/>
