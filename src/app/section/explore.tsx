    ...
    return(
        <section id="Events" className="my-16">
            ...
            <div className="flex flex-col md:flex-row my-10 sm:justify-evenly justify-center items-center">
                ...
                <Card alamat="https://www.eventbrite.com/e/sidang-senat-dan-orasi-ilmiah-tickets-661844263007" wa="https://wa.me/6282276264815" heading="Sidang Senat" caption="GEDUNG G" image="https://plus.unsplash.com/premium_photo-1661856221850-8d6cc299049c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=687&q=80" text="Join Now!" panduan="#" check="https://docs.google.com/spreadsheets/d/1x7W3uul1EVX1l1ECnyu1xNizItCLKTJ4fbPzPSwqR18/edit#gid=0"/>
            </div>
