    ...
    return(
        <section id="Events" className="my-16">
            ...
            <div className="flex flex-col md:flex-row my-10 sm:justify-evenly justify-center items-center">
                ...
                <Lombacard alamat="https://www.eventbrite.com/e/the-effect-of-climate-change-on-property-value-fact-or-fiction-tickets-665040111877" wa="http://wa.me/6282131002008" image="https://images.unsplash.com/photo-1569038786784-24a715a36507?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=735&q=80" heading="International Seminar" caption="GEDUNG N" text="Join Now!" panduan="https://drive.google.com/drive/u/0/folders/1M9Ue_7h7lplCUBv5VM3odnDzFuzNQ9ln" check="/events/seminarclimatechange"/>
