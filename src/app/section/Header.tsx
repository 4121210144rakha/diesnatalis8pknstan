...
export default function Header() {
    return(
        <section className="h-screen mask-image-to-bottom">
            <video id='backgroundVideo' playsInline={true} className="mask-image-to-bottom object-cover fixed h-screen w-screen -z-50 top-0 left-0 right-0 bottom-0" autoPlay={true} loop={true} height={1000} width={1000}><source src={"/videos/trailer.mp4"}/></video>
