      ...
      <>
        <section className="h-screen flex flex-col items-center justify-center">
            <div className="border border-green-500 relative" style={{height:document.getElementById("video1")?.style.height}}>
              ...
              <div id="videoPlayer" className="w-full h-fit bottom-0 absolute flex flex-row items-center p-2 pt-6 bg-black bg-opacity-80 mask-image-to-top transition ease-in-out duration-150">
                <button onClick={()=>{
                ...
                <div className='w-full relative ml-2'>
                  <progress 
                    value={currentTime}
                    max={duration}
                    className="absolute top-0 left-0 w-full"></progress>

                  <input
                      type='range'
                      id='barVideo'
                      className='absolute top-0 left-0 z-10 w-full opacity-0 hover:opacity-100 transition ease-in-out duration-150 cursor-pointer'
                      step={0.001}
                ...
                <div id="videoOption" className="absolute bottom-0 flex flex-row items-center justify-around w-full bg-black py-4 ">
